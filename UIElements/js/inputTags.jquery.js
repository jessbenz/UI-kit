(function($) {
  ...
  $.fn.inputTags = function(options) {
    ...
    if ('object' === typeof options || !options) {
      ...
      var obj = this.each(function() {
        ...
        self.ITEM_CONTENT  = '<span class="value" title="Click to edit">%s</span><i class="close-item">&times</i>';
  ...
  $.fn.inputTags.defaults = {
    ...
    errors: {
      empty: 'You can not add an empty tag.',
      minLength: 'Your tag must be at least 2 characters.',
      maxLength: 'Your tag should not exceed 30 characters.',
      max: 'The number of tags should not exceed 6.',
